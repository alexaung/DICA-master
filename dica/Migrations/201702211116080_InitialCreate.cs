                ...
                c => new
                    {
                        ...
                        LocalEquity = c.Decimal(nullable: false, precision: 18, scale: 3),
                        LocalLone = c.Decimal(nullable: false, precision: 18, scale: 3),
                        ForeginEquity = c.Decimal(nullable: false, precision: 18, scale: 3),
                        ForeginLone = c.Decimal(nullable: false, precision: 18, scale: 3),
                    })
                .PrimaryKey(t => t.UID);
                ...
                c => new
                    {
                        ...
                        AmountofForeignCapital = c.Decimal(nullable: false, precision: 18, scale: 3),
                        PeriodforForeignCapitalBroughtin = c.Int(nullable: false),
                        TotalAmountofCapital = c.Decimal(nullable: false, precision: 18, scale: 3),
                        ...
                        Landowner = c.String(),
                        LandArea = c.Decimal(nullable: false, precision: 18, scale: 3),
